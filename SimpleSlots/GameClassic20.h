...
typedef void(^SiWinSuccessBlock)();
typedef void(^SiwinCancelBlock)();
...
#import "Popup.h"
#import "popup_rate.h"
@interface GameClassic20 : ViewController <GameCenterManagerDelegate, GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate, NSURLConnectionDelegate,UIAlertViewDelegate,popupDelegate,popupRateDelegate>{
    ...
    NSTimer *scheduleBonus, *dropCoinsTimer,*rowTimer;
