...
//    NSLog(@"degreesWheel: %f", degreesWheel);
    ...
    /*
    if(currently > 16){
        currently = currently - 16;
    }else if(currently > 8){
        currently = currently - 8;
    }*/
    
//    NSLog(@"current: %i", currently);
//    NSLog(@"wheelTo: %i", [[NSString stringWithFormat:@"%f", ((wheelSpinTo)/22.5)] intValue]);
