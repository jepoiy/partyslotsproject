...
- (IBAction)spinPressed:(id)sender {
    [btnSpin setImage:[UIImage imageNamed:@"spin_iphone@2x_pressed.png"] forState:UIControlStateHighlighted];
}
...
- (void)viewDidLoad{
    ...
    obj = [[Popup alloc] initWithNibName:@"Popup" bundle:nil];
    obj.delegate = self;
...
-(void)btnYesClick:(NSString *)tag{
    ...
    rateobj.delegate = self;
    [self presentPopupViewController:rateobj animationType:MJPopupViewAnimationFade];
