...
@interface BaseViewController : UIViewController<NSURLConnectionDelegate, GameCenterManagerDelegate,  GKLeaderboardViewControllerDelegate, GKAchievementViewControllerDelegate>
{
